...
<body>
    ...
    <div class="banner">
        <header style="background-color: #FF9933; color: white; padding: 20px 0; font-family: Arial, sans-serif; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            ...
            <p style="margin: 10px 0 0; font-size: 1.2em;">( पर्व - २)</p>
        </header>
    </div>
    <div class="nav-bar">
        <div class="dropdown">
    ...
    <div class="container">
        ...
        <div id="about-us-container" style="display:none;">
            ...
            <p><b>Matches</b> - सर्व मॅचेस लीगच्या पद्धतीने खेळवण्यात येतील. प्रत्येक संघ आपल्या गटातील इतर संघांसोबत लीग मॅचेस खेळतील. 
             ...
             <p>जर लीगमधील काही संघांचे पॉइंट्स समान असतील, तर नेट रनरेटला किवा जास्त सिक्सएस यांना प्राधान्य दिले जाईल.</p>
